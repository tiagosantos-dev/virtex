  	...
  	<div id="slider">
        <ul id="sliderContent">
            <li class="sliderImage">
                <a href=""><img src="Images/banner2.fw.png" alt="1" /></a>
                <span class="top"><strong>Title text 1</strong><br />Content text...</span>
            </li>
            <li class="sliderImage">
                <a href=""><img src="Images/banner3.fw.png" alt="2" /></a>
            ...
            <li class="sliderImage">
                <img src="Images/banner3.fw.png" alt="3" />
                <span class="bottom"><strong>Title text 2</strong><br />Content text...</span>
            </li>
            <li class="sliderImage">
                <img src="Images/banner4.fw.png" alt="4" />
                <span class="bottom"><strong>Title text 2</strong><br />Content text...</span>
            </li>
